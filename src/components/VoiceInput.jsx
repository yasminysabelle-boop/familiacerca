...
export default function VoiceInput({
  ...
  const micColor   = recording ? '#EF4444' : '#4A7C59'
  const micBg      = recording ? 'rgba(239,68,68,0.08)' : 'rgba(74,124,89,0.08)'
  const inputStyle = {
    width: '100%',
      ...
      {onSave && value.trim() && (
        <button
          ...
          style={{
            ...
            borderRadius: 10,
            border: 'none',
            background: saving ? '#9CA3AF' : '#4A7C59',
            color: 'white',
            fontWeight: 700,
            fontSize: 13,
...
function MicIcon({ color = '#4A7C59', size = 16 }) {
  return (
