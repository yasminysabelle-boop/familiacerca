          ...
          <div className="flex-1 min-w-0">
            ...
            {sent && pushFailed && (
              <div style={{ marginTop: 8 }}>
                <p className="text-xs font-semibold flex items-center gap-1.5" style={{ color: '#0d6b63' }}>
                  <AlertTriangle size={12} color="#0d6b63" strokeWidth={2} />
                ...
                {fallbackContacts.length > 0 ? (
                  <div style={{ marginTop: 6, display: 'flex', flexDirection: 'column', gap: 4 }}>
                    {fallbackContacts.map((c, i) => (
                      ...
                      >
                        <Phone size={13} color="#0d6b63" strokeWidth={2} />
