    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Header */}
          <div style={{
            background: 'linear-gradient(135deg, #C4623A 0%, #A85130 100%)',
        ...
        <div style={{
          width: '100vw', height: '100%', flexShrink: 0,
          background: 'linear-gradient(160deg, #C4623A 0%, #8C3E22 58%, #5C2610 100%)',
          position: 'relative',
          display: 'flex', flexDirection: 'column',
          alignItems: 'center', justifyContent: 'center',
          padding: '0 28px',
          ...
          <button
            ...
            style={{
              ...
              background: isLightSlide
                ...
                : 'white',
              color: isLightSlide ? 'white' : '#C4623A',
