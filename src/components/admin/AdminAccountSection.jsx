...
const PLAN_META = {
  ...
  familiar:  { label: 'Plan Familiar',   color: '#4A7C59', icon: '❤️', features: ['6 cuidadores', 'Recordatorios automáticos', 'Notas de voz', 'Foto-prueba', 'Reportes PDF', 'Álbum y gastos'] },
      ...
      {(trialExpired || sub.plan === 'free') && (
        <button
          ...
          style={{
            ...
            cursor: 'pointer', boxShadow: '0 4px 16px rgba(74,124,89,0.3)',
          }}
        >
