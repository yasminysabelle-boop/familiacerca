...
// (ver FamilyPlanContext.jsx, familyAiLevel — plan de la familia, no del
// viewer). Cada nivel agrega una capa sobre la anterior; nunca resta las
// reglas base de arriba.
const DEPTH = {
...
// FamilyPlanContext.jsx, familyAiLevel). Ya no hay límite de frecuencia por plan: cache
